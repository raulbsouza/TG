            ...
            <table  class="largura100">
                ...
                <tbody>
                    <c:forEach var="cliente" items="${clientes}">                    
                        <tr>
                            <td align="left">${cliente.idCliente}</td>                    
                            <td align="left">${cliente.nome}</td>
                            <td align="left">${cliente.cpfCnpj}</td>
                            <td align="left">${cliente.cidade.nomeCidade}-${cliente.cidade.estado.siglaEstado}</td>
                            <td align="left">
                            ...
                            <td align="center">
                                <a href="#" onclick="deletar(${cliente.idCliente})">
                                    <button class="btn
                                            <c:out value="${cliente.situacao == 'A' ? 'btn-danger': 'btn-success'}"/>">
                                        <i class="fas fa-fw
                                           <c:out value="${cliente.situacao == 'A' ? 'fa-times' : ' fa-plus'}"/>"></i>
                                        <Strong>
                                            <c:out value="${cliente.situacao == 'A' ? 'Inativar': 'Ativar'}"/>
                                        </Strong>
                                    </button></a>
                            </td>
                        </tr>                
...
<script>
    ...
    function setDadosModal(valor) {
        ...
        if (idAdm != "0") {
            ...
            $.getJSON('ClienteCarregar', {idcliente: idAdm}, function (respostaServlet) {
