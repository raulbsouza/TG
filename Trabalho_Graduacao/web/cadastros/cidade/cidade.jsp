        ...
        <tbody>
            <c:forEach var="cidade" items="${cidades}">                    
                <tr>
                    ...
                    <td align="left" class="cep">${cidade.cep}</td>
                    <td align="center">
...
<div align="center">        
    <a class="btn btn-success mb-4" href="${pageContext.request.contextPath}/CidadeNovo">Novo</a>
    <a class="btn btn-secondary mb-4" href="index.jsp">Voltar à Página Inicial</a>
</div>        
