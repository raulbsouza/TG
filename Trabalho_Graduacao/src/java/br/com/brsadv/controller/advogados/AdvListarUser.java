 ...
 * @author Aluno
 */
@WebServlet(name = "AdvListarUser", urlPatterns = {"/AdvListarUser"})
public class AdvListarUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/cadastros/adv/advs.jsp").forward(request, response);
        } catch (Exception ex) {
