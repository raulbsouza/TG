 ...
 * @author Aluno
 */
@WebServlet(name = "EnderecoNovo", urlPatterns = {"/EnderecoNovo"})
public class EnderecoNovo extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("endereco", oEndereco);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EnderecoNovo.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
